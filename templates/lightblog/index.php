...
<div class="copyright">Copyright &copy; <?php echo (date("Y")); ?> <?php $config = new JConfig(); echo $config->sitename; ?> 
<br /><?php echo $templatecopy; ?>
<br /><a href="index.php/component/content/article?layout=edit&id=10">Impressum</a>
</div>
